...
import '../../main.dart'; // Wajib ada untuk membaca status Dark Mode & Bahasa
...
class _ProfileScreenState extends State<ProfileScreen> {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () { _saveProfileData(nameController.text, descController.text); Navigator.pop(context); },
          ...
          child: Column(
            children: [
                ...
                children: [
                  Container(
                    ...
                    child: Container(
                      ...
                      child: CircleAvatar(radius: 55, backgroundImage: NetworkImage(_avatarUrl)),
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: cardColor, shape: BoxShape.circle, border: Border.all(color: bgColor, width: 3), boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.1), blurRadius: 8, offset: const Offset(0, 4))]),
                      child: const Icon(Icons.edit_rounded, size: 18, color: Color(0xFFCC6633)),
                    ),
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  _buildStatCircle(value: "12,500", label: "TOTAL XP", icon: Icons.bolt_rounded, iconColor: const Color(0xFFCC6633), cardColor: cardColor, textColor: textColor, subTextColor: subTextColor, borderColor: borderColor),
                  _buildStatCircle(value: "32", label: _t("DAYS STREAK", "REKOR HARI"), icon: Icons.local_fire_department_rounded, iconColor: const Color(0xFFB85C2A), cardColor: cardColor, textColor: textColor, subTextColor: subTextColor, borderColor: borderColor),
                  _buildStatCircle(value: "450/700", label: _t("WORDS (N5)", "KATA (N5)"), icon: Icons.menu_book_rounded, iconColor: const Color(0xFFE08B4B), cardColor: cardColor, textColor: textColor, subTextColor: subTextColor, borderColor: borderColor),
                ],
              ),
              const SizedBox(height: 24),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Container(
                      width: 56, height: 56,
                      decoration: BoxDecoration(color: isDark ? const Color(0xFF3A2415) : const Color(0xFFFFF4E8), borderRadius: BorderRadius.circular(16)),
                      child: const Icon(Icons.local_fire_department_rounded, color: Color(0xFFCC6633), size: 30),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(_t("You're 75% done!", "Sudah selesai 75%!"), style: TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: textColor)),
                          const SizedBox(height: 8),
                          ClipRRect(borderRadius: BorderRadius.circular(10), child: LinearProgressIndicator(value: 0.75, minHeight: 6, backgroundColor: isDark ? const Color(0xFF333333) : const Color(0xFFF1EFE8), valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFFCC6633)))),
                        ],
                      ),
                    ),
                    const SizedBox(width: 16),
                    const Text("75%", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w900, color: Color(0xFFCC6633))),
                  ],
                ),
              ),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: isDark ? const Color(0xFF3A2415) : const Color(0xFFFFF4E8), borderRadius: BorderRadius.circular(20)),
                        child: const Row(
                          children: [
                            Icon(Icons.emoji_events_rounded, size: 16, color: Color(0xFFCC6633)),
                            SizedBox(width: 6),
                            Text("3 / 4", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w900, color: Color(0xFFCC6633))),
                          ],
                        ),
                      ),
                    ],
                  ...
                  SizedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        _buildAchievementCardH(badge: _AchievementBadge.text("あ"), bgColor: const Color(0xFFEBE5DB), accentColor: const Color(0xFF7A6652), title: "Hiragana\nMaster", progress: 1.0, isCompleted: true, cardColor: cardColor, textColor: textColor, borderColor: borderColor, isDark: isDark, subTextColor: subTextColor),
                        _buildAchievementCardH(badge: _AchievementBadge.text("ア"), bgColor: const Color(0xFFFFF4E8), accentColor: const Color(0xFFCC6633), title: "Katakana\nExplorer", progress: 0.6, progressLabel: "60 / 100", cardColor: cardColor, textColor: textColor, borderColor: borderColor, isDark: isDark, subTextColor: subTextColor),
                        _buildAchievementCardH(badge: _AchievementBadge.label("N5"), bgColor: const Color(0xFFCC6633), badgeTextColor: Colors.white, accentColor: const Color(0xFFCC6633), title: "N5\nBeginner", progress: 0.45, progressLabel: "450 / 700", cardColor: cardColor, textColor: textColor, borderColor: borderColor, isDark: isDark, subTextColor: subTextColor),
                        _buildAchievementCardH(badge: _AchievementBadge.text("日"), bgColor: const Color(0xFFF1EFE8), accentColor: const Color(0xFFB4B2A9), title: "Kanji N5\nPioneer", progress: 0.0, progressLabel: "0 / 100", isLocked: true, cardColor: cardColor, textColor: textColor, borderColor: borderColor, isDark: isDark, subTextColor: subTextColor),
                      ],
                    ),
                  ),
                ],
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildMenuTile(context: context, icon: Icons.settings_rounded, title: _t("Settings", "Pengaturan"), subtitle: _t("Manage your preferences", "Kelola preferensi akunmu"), color: const Color(0xFFCC6633), textColor: textColor, subTextColor: subTextColor, isDark: isDark, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SettingsScreen()))),
                        ...
                        showDialog(
                          ...
                          builder: (ctx) => AlertDialog(
                            ...
                            actions: [
                              ...
                              ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.red, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))), onPressed: () => Navigator.pop(ctx), child: Text(_t("Log Out", "Keluar"), style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                            ],
                          ),
                        );
                      },
  ...
  Widget _buildStatCircle({required String value, required String label, required IconData icon, required Color iconColor, required Color cardColor, required Color textColor, required Color subTextColor, required Color borderColor}) {
    return Container(
      ...
      decoration: BoxDecoration(color: cardColor, shape: BoxShape.circle, border: Border.all(color: borderColor), boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.02), blurRadius: 15, offset: const Offset(0, 8))]),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(icon, size: 24, color: iconColor),
          const SizedBox(height: 4),
          Text(value, style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14, color: textColor)),
          const SizedBox(height: 2),
          Text(label, textAlign: TextAlign.center, style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: subTextColor, letterSpacing: 0.5)),
        ],
      ),
    );
  }
  ...
  Widget _buildAchievementCardH({required _AchievementBadge badge, required Color bgColor, required Color accentColor, Color badgeTextColor = Colors.black87, required String title, required double progress, String? progressLabel, bool isCompleted = false, bool isLocked = false, required Color cardColor, required Color textColor, required Color borderColor, required bool isDark, required Color subTextColor}) {
    return Opacity(
      ...
      child: Container(
        width: 135, margin: const EdgeInsets.only(right: 16), padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(color: cardColor, borderRadius: BorderRadius.circular(24), border: Border.all(color: isCompleted ? const Color(0xFFC8E6C9).withValues(alpha: isDark ? 0.2 : 1) : borderColor, width: 2), boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.02), blurRadius: 10, offset: const Offset(0, 4))]),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Stack(
              clipBehavior: Clip.none,
              children: [
                Container(width: 56, height: 56, decoration: BoxDecoration(color: isDark ? bgColor.withValues(alpha: 0.5) : bgColor, shape: BoxShape.circle), child: Center(child: Text(badge.text, style: TextStyle(fontSize: badge.isLabel ? 18 : 28, fontWeight: FontWeight.w900, color: badgeTextColor)))),
                if (isCompleted) Positioned(bottom: -2, right: -2, child: Container(width: 22, height: 22, decoration: BoxDecoration(color: const Color(0xFF558B2F), shape: BoxShape.circle, border: Border.all(color: cardColor, width: 2)), child: const Icon(Icons.check_rounded, size: 14, color: Colors.white))),
                if (isLocked) Positioned(bottom: -2, right: -2, child: Container(width: 22, height: 22, decoration: BoxDecoration(color: cardColor, shape: BoxShape.circle, border: Border.all(color: borderColor, width: 2)), child: const Icon(Icons.lock_rounded, size: 12, color: Color(0xFF8C8A87)))),
              ],
            ),
            const Spacer(),
            Text(title, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w900, color: isLocked ? const Color(0xFF8C8A87) : textColor, height: 1.2)),
            const SizedBox(height: 10),
            ClipRRect(borderRadius: BorderRadius.circular(99), child: LinearProgressIndicator(value: progress, minHeight: 6, backgroundColor: isDark ? const Color(0xFF333333) : const Color(0xFFF1EFE8), valueColor: AlwaysStoppedAnimation<Color>(isCompleted ? const Color(0xFF558B2F) : accentColor))),
            const SizedBox(height: 6),
            if (isCompleted) Text(_t("Completed", "Selesai"), style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: Color(0xFF558B2F)))
            else if (progressLabel != null) Text(progressLabel, style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: subTextColor)),
          ],
        ),
      ),
    );
  ...
  Widget _buildMenuTile({required BuildContext context, required IconData icon, required String title, required String subtitle, required Color color, required Color textColor, required Color subTextColor, required VoidCallback onTap, bool isLogout = false, required bool isDark}) {
    return ListTile(
      ...
      leading: Container(
        ...
        decoration: BoxDecoration(color: isLogout ? (isDark ? Colors.red.withValues(alpha: 0.2) : const Color(0xFFFFF1F1)) : color.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(16)),
      ...
      trailing: const Icon(Icons.arrow_forward_ios_rounded, size: 16, color: Color(0xFFB5B0A8)),
      onTap: onTap,
    );
  }
}